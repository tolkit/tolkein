...
When `reporting a bug <https://github.com/tolkit/tolkein/issues>`_ please include:
...
1. Fork `tolkein <https://github.com/tolkit/tolkein>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/tolkit/tolkein/pull_requests>`_ for each change you add in the pull request.
